    ...
    execute({ inter }) {
        ...
        switch (inter.options._hoistedOptions.map(x => x.value).toString()) {
            ...
            case 'enable_autoplay': {
                if (queue.repeatMode === QueueRepeatMode.AUTOPLAY) return inter.reply({ content: `You must first disable the current music in the loop mode (/loop Disable) ${inter.member}... try again ? ❌`, ephemeral: true });
